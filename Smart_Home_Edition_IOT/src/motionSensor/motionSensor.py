...
def RPCClient():
	...
	while True:
		...
		event.clear()
		#proc = ['Mo','G']
		proxyGateway.report_state(motion.get_timestamp(),motion.get_ID(motion.Clock()), motion.get_state(motion.Clock()), motion.Clock(),['motionSensor','G']) ## reporting to gateway
